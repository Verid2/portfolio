    ...
    return (
        <>
            <div className="w-screen h-screen relative mx-80 bg-white">
                ...
                <div className="left-[551px] top-[768px] absolute text-white text-[20px] font-medium">Login</div>
                <div className="left-[364px] top-[829px] absolute text-black text-[20px] font-thin">If you don’t have an  account please register here.</div>
